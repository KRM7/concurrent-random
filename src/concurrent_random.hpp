#ifndef BENCHMARK_CONCURRENT_RANDOM_HPP
#define BENCHMARK_CONCURRENT_RANDOM_HPP
...
class xorshift64s_atomic
{
public:
    using result_type = uint64_t;
    using state_type  = uint64_t;

    explicit constexpr xorshift64s_atomic(uint64_t seed) noexcept
        : state(seed)
    {}
...
public:
    ...
    result_type operator()() noexcept
    {
        result_type z = state.fetch_add(0x9e3779b97f4a7c15, std::memory_order::relaxed) + 0x9e3779b97f4a7c15;
...
#endif // !BENCHMARK_CONCURRENT_RANDOM_HPP
